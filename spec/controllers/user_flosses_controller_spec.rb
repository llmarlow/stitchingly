...
RSpec.describe UserFlossesController, type: :controller do
  ...
  # UserFloss. As you add validations to UserFloss, be sure to
  ...
  describe "GET #new" do
    it "assigns a new user_floss as @user_floss" do
  ...
  describe "GET #edit" do
    it "assigns the requested user_floss as @user_floss" do
      user_floss = UserFloss.create! valid_attributes
      get :edit, params: {id: user_floss.to_param}, session: valid_session
      expect(assigns(:user_floss)).to eq(user_floss)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created user_floss" do
        post :create, params: {user_floss: valid_attributes}, session: valid_session
        expect(response).to redirect_to(UserFloss.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the user_floss" do
        user_floss = UserFloss.create! valid_attributes
        put :update, params: {id: user_floss.to_param, user_floss: valid_attributes}, session: valid_session
        expect(response).to redirect_to(user_floss)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested user_floss" do
      user_floss = UserFloss.create! valid_attributes
      expect {
        delete :destroy, params: {id: user_floss.to_param}, session: valid_session
      }.to change(UserFloss, :count).by(-1)
    end

    it "redirects to the user_flosses list" do
      user_floss = UserFloss.create! valid_attributes
      delete :destroy, params: {id: user_floss.to_param}, session: valid_session
      expect(response).to redirect_to(user_flosses_url)
    end
  end
