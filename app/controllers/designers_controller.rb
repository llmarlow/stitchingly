class DesignersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @designer.save
        format.html { redirect_to designers_path, notice: 'Designer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @designer.update(designer_params)
        format.html { redirect_to designers_path, notice: 'Designer was successfully updated.' }
  ...
  private
    ...
    def designer_params
      params.require(:designer).permit(:name, :website, :description)
    end
end
