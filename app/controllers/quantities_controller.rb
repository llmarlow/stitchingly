class QuantitiesController < ApplicationController
  ...
  def create
    @quantity = Quantity.new(:user_id => params[:user_id], :floss_id => params[:floss_id], :quantity => 1)
    respond_to do |format|
      if @quantity.save
        format.html { redirect_to flosses_path, notice: 'Quantity was successfully created.' }
  ...
  private
    ...
    def quantity_params
      params.require(:quantity).permit(:user_id, :floss_id, :quantity)
    end
end
